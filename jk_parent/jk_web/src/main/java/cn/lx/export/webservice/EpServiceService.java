 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.export.lx.cn/", wsdlLocation = "http://localhost:8080/jk_exportServ/ws/export?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EPSERVICESERVICE_QNAME = new QName("http://webservice.export.lx.cn/", "EpServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jk_exportServ/ws/export?wsdl");
    ...
    public IEpService getEpServicePort() {
        return super.getPort(new QName("http://webservice.export.lx.cn/", "EpServicePort"), IEpService.class);
    }
    ...
    public IEpService getEpServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.export.lx.cn/", "EpServicePort"), IEpService.class, features);
    }
