...
<head>
	...
	<script>
	     ...
	     function toView(){
	    	 if(isOnlyChecked()){
	    		 formSubmit('moduleAction_view','_self');
	    	 }else{
	     ...
	     function toUpdate(){
	    	 if(isOnlyChecked()){
	    		 formSubmit('moduleAction_updateUI','_self');
	    	 }else{
	    		 alert("请先选择一项并且只能选择一项，再进行操作！");
	    	 }
	     }
...
<li id="new"><a href="#" onclick="formSubmit('moduleAction_addUI','_self');this.blur();">新增</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" align="left">
		...
		<td><a href="moduleAction_view?id=${o.id}">${o.name}</a></td>
		<td>${o.layerNum}</td>
		<td>${o.cpermission}</td>
		<td>${o.curl}</td>
		<td>${o.ctype}</td>
