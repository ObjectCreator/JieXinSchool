...
<head>
	...
	<script>
	     ...
	     function toView(){
	    	 if(isOnlyChecked()){
	    		 formSubmit('roleAction_view','_self');
	    	 }else{
	     ...
	     function toUpdate(){
	    	 if(isOnlyChecked()){
	    		 formSubmit('roleAction_updateUI','_self');
	    	 }else{
	    		 alert("请先选择一项并且只能选择一项，再进行操作！");
	    	 }
	     }
	     ...
	     function toModule(){
	    	 if(isOnlyChecked()){
	    		 formSubmit('roleAction_moduleUI','_self');
	    	 }else{
	    		 alert("请先选择一项并且只能选择一项，再进行操作！");
	    	 }
	     }
...
<li id="new"><a href="#" onclick="formSubmit('roleAction_addUI','_self');this.blur();">新增</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" align="left" >
		...
		<td>${o.id}</td>
		<td><a href="roleAction_view?id=${o.id}">${o.name}</a></td>
		<td>${o.remark}</td>
	</tr>
	</c:forEach>
