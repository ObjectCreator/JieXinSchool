...
<script src="${ctx}/js/jquery-1.11.0.js" type="text/javascript" charset="utf-8"></script>
<script src="${ctx}/js/jquery.validate.js" type="text/javascript" charset="utf-8"></script>
<script src="${ctx}/js/messages_zh.js" type="text/javascript" charset="utf-8"></script>
