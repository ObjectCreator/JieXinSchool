...
<script src="${ctx}/amcharts/gauge.js" type="text/javascript"></script>

  	<link rel="stylesheet" href="${ctx }/themes/default/easyui.css" type="text/css"></link>
    <link rel="stylesheet" href="${ctx }/themes/icon.css" type="text/css"></link>
    <script type="text/javascript" src="${ctx }/js/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="${ctx }/js/easyui-lang-zh_CN.js"></script>

<script type="text/javascript">
	$(function(){
		var url="${ctx}/admin/userBaseInfoAction_upLonin";
...
<li id="stat"><a href="${ctx}/admin/userBaseInfoAction_history">历史</a></li>
...
包括合同、报运、装箱、委托、发票等业务
		...
		<div 
			id="chartdiv" style="width:1900px; height:250px;">
		</div>
