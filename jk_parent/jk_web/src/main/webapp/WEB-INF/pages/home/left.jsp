	       ...
	       <div class="panel-header">
	        ...
	        <div class="panel-content">
				<ul>
					...
					<li><a href="${ctx}/admin/feedbackAction_list" target="main" id="aa_1" onclick="linkHighlighted(this)">意见反馈</a></li>
				</ul>
	        </div>
...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-content">
			<ul>
				<li><a href="${ctx}/admin/userBaseInfoAction_toview" target="main" id="aa_2">个人信息查看</a></li>
				<li><a href="${ctx}/admin/userBaseInfoAction_toupdate" target="main" id="aa_2">个人信息修改</a></li>				
