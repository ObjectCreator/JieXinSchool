...
<div id="sidebar" class="sidebar">
	<div class="sidebar_t">
		...
		<%--   <ul>					
				 <li>
					<a href="${ctx}/basicinfo/factoryAction_list" onclick="linkHighlighted(this)" target="main" id="aa_1">厂家信息</a>
				</li>
				<li>
					<a href="${ctx}/basicinfo/productAction_list" id="aa_1" onclick="linkHighlighted(this)">产品信息</a>
				</li> 
		 </ul>   --%>
