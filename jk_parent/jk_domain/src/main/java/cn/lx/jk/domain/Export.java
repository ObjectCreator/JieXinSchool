...
public class Export extends BaseEntity implements Serializable{
	...
	private Integer state;				//0-草稿 1-提交 3-装箱 4-委托 5-发票 6-财务 2--已报运
	
	private Integer exProductNum;        //报运单所包含的货物数
	private Integer extEproductNum;		//报运单所包含的附件数
	public String getId() {
		return id;
	}
	...
	public Integer getExtEproductNum() {
		return extEproductNum;
	}
	public void setExtEproductNum(Integer extEproductNum) {
		this.extEproductNum = extEproductNum;
	}
	public Integer getExProductNum() {
		return exProductNum;
	}
	public void setExProductNum(Integer exProductNum) {
		this.exProductNum = exProductNum;
	}
